...
public class Main {
	public static void main(String[] args) {
		// Layout Manager = defined natural layout for components with in container
	
		// 3 Common Manager
	
		// Border Layout -> place components into 5 area: NORTH, SOUTH, WEST, EAST,CENTER.
		//                 All extra spaces placed center
